...
{
    public static class NonStaticTypeTranspiler
    {
        public static readonly MethodInfo transpiler;
        public static List<Type> typeToReplace;

        static NonStaticTypeTranspiler()
        {
            transpiler = typeof(NonStaticTypeTranspiler).GetMethod("Transpiler", BindingFlags.Static | BindingFlags.Public);
        ...
        {
            // pop all arguments
            int parameterCount = data.CalledMethod.GetParameters().Length + 1; // +1 to pop the Player instance
        ...
        private static IEnumerable<CodeInstruction> ReplaceCalls(IEnumerable<CodeInstruction> instructions, InsertCallData.InsertCall modify, MethodInfo transpiler, ILGenerator generator, string methodKey)
        {
            ...
            while (current != null)
            {
                ...
                {
                    if (typeToReplace.Contains(method.DeclaringType))
                    {
