...
{
    [TestFixture]
    internal class Test_3rd_Person_Input_System_Replay
    {
        private const string ASSET_GUID = "c91ffc1775fe26c4dac674d4fb486ec4";
        ...
        [UnityTest]
        public IEnumerator Run_3rd_Person_Input_System_Replay()
        {
