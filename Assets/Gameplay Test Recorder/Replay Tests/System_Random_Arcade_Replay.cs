...
{
    [TestFixture]
    internal class Test_System_Random_Arcade_Replay
    {
        private const string ASSET_GUID = "97182d1db1b4c3046992e265bf62edce";
        ...
        [UnityTest]
        public IEnumerator Run_System_Random_Arcade_Replay()
        {
