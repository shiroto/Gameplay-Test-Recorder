...
{
    [TestFixture]
    internal class Test_TMPro_Input_System_Replay
    {
        private const string ASSET_GUID = "cebdf3aacd5c21a45823665121cb4f41";
        ...
        [UnityTest]
        public IEnumerator Run_TMPro_Input_System_Replay()
        {
