...
{
    [TestFixture]
    internal class Test_3rd_Person_Rewired_Replay
    {
        private const string ASSET_GUID = "a60c7d5c3feea0c4ea546ec02d398c2f";
        ...
        [UnityTest]
        public IEnumerator Run_3rd_Person_Rewired_Replay()
        {
